...
{
    echo "<h2 align='center' style='color:#008888;'> User Information</h2>";
    echo "<form action='#' method='post'>";
    echo "Name <input type='text' name='name'><br><br>";
    echo "Contact details<input type='number' name='contact'><br><br>";
    echo "Occasion date<input type='date' name='occasion'><br><br>";
    echo "Capacity<input type='number' name='capacity'><br><br>";
    echo "</form>";
